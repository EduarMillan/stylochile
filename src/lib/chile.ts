 ...
 * Las claves son los nombres oficiales de las regiones según la
 * división política-administrativa vigente.
 */
...
export const CHILE_REGIONES = Object.keys(CHILE_COMUNAS);
